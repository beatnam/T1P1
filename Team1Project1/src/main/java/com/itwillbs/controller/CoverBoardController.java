...
public class CoverBoardController {
	...
	public String content(Model model, HttpServletRequest request) {
		...
		CareearDTO careearDTO = new CareearDTO();
		...
		model.addAttribute("careearDTO", careearDTO);
...
//		}
	...
	public String updatePro(HttpServletRequest request, MultipartFile recruitPhoto) throws IOException {
		System.out.println("CoverBoardController updatePro()");
		...
		recruitDTO.setRecruitCareear(Integer.parseInt(request.getParameter("recruitCareear")));
