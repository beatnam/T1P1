...
public class CommentController {
	...
	// 댓글 삽입
	@PostMapping("/add")
	public String addComment(@RequestParam("re_num") int reNum, @RequestParam("ce_content") String ceContent,
			HttpSession session) {
	...
	// 댓글 수정
	@PostMapping("/update")
	public String updateComment(@RequestParam("re_num") int reNum, @RequestParam("ce_id") int ceId,
	...
	// 댓글 삭제
	@PostMapping("/delete")
	public String deleteComment(@RequestParam("ce_id") int ceId, @RequestParam("re_num") int reNum) {
	...
	// 댓글 삽입
	@PostMapping("/riadd")
	public String addriComment(@RequestParam("ri_num") int riNum, @RequestParam("ci_content") String ciContent,
			HttpSession session) {
	...
	public String updateriComment(@RequestParam("ri_num") int riNum, @RequestParam("ci_id") int ciId,
	...
	public String deleteriComment(@RequestParam("ci_id") int ciId, @RequestParam("ri_num") int riNum) {
	...
	public String addriReplies(@RequestParam("ri_num") int riNum, @RequestParam("parent_id") int parentId,
			@RequestParam("ci_content") String ciContent, HttpSession session) {
		int memberNum = (int) session.getAttribute("num");
		RiBoardCMDTO riBoardCMDTO = new RiBoardCMDTO();
		riBoardCMDTO.setRiNum(riNum);
		riBoardCMDTO.setCiContent(ciContent);
	...
	public String rerepliesadd(@RequestParam("re_num") int reNum, @RequestParam("parent_id") int parentId,
			@RequestParam("ce_content") String ceContent, HttpSession session) {
		int memberNum = (int) session.getAttribute("num");
		RcBoardCMDTO rcBoardCMDTO = new RcBoardCMDTO();
		rcBoardCMDTO.setReNum(reNum);
		rcBoardCMDTO.setCeContent(ceContent);
