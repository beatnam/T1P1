...
<head>
<meta charset="UTF-8">
<title>상시채용 | 지원하기</title>

<script
	src="${pageContext.request.contextPath}/resources/js/jquery-1.11.3.min.js"></script>

<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/direct_application.css">
</head>
<body>
	...
	<div class="bottom-form-container">
		...
		<form action="#" method="post">
			...
			<input type="hidden" id="selectedCompany" name="companyName" value="">
