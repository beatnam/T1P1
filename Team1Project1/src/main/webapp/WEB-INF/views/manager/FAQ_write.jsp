...
<body>
    ...
    <form action="#" method="post">
        ...
        <input type="text" id="faq_subject" name="faq_subject" required><br><br>

        <label for="faq_content">faq_content:</label><br>
        <input type="text" id="faq_content" name="faq_content" required><br><br>
