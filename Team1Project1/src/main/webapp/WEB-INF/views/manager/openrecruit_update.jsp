...
<body>
    ...
    <div>
        ...
        <form action="#" method="post">
            ...
            <input type="text" id="or_corporation_name" name="or_corporation_name" placeholder="회사명" required><br>

            <label for="or_name">공고명:</label>
            <input type="text" id="or_name" name="or_name" placeholder="공고명" required><br>

            <label for="or_occupation">직종:</label>
            <input type="text" id="or_occupation" name="or_occupation" placeholder="직종" required><br>

            <label for="or_job">직무:</label>
            <input type="text" id="or_job" name="or_job" placeholder="직무" required><br>

            <label for="or_eduhigh">학력:</label>
            <input type="text" id="or_eduhigh" name="or_eduhigh" placeholder="학력" required><br>

            <label for="or_location">지역:</label>
            <input type="text" id="or_location" name="or_location" placeholder="지역" required><br>

            <label for="or_salary">연봉:</label>
            <input type="text" id="or_salary" name="or_salary" placeholder="연봉" required><br>

            <label for="or_url">회사 홈페이지:</label>
            <input type="text" id="or_url" name="or_url" placeholder="회사 홈페이지" required><br>

            <label for="or_deadline">마감일:</label>
            <input type="text" id="or_deadline" name="or_deadline" placeholder="마감일" required><br>
