				...
				<ul class="joinList">
					...
					<li class="start">
						<div class="join_content checkbox_area">
							...
							<a
								href="${pageContext.request.contextPath}/customerService/customerService"
								target="_blank" class="link">내용 보기</a>
						</div>
					</li>
					...
					<li class="start">
						<div class="join_content checkbox_area">
							<label>
								<input type="checkbox" name="corpInfoC" id="infoC" value="true" />
