					...
					<div class="container1">
						...
						<li class="start">
							<div class="join_content email_area">
								...
								<span class="ico_space">@</span> <input type="text"
									name="email2" class="w160" title="이메일 제공업체 입력" required />
...
<!-- 						<li class="start"> -->
<!-- 							<div class="join_content"> -->
<!-- 								회사 대표 이미지 <input type="text" name="corporationPhoto" -->
...
<!-- 						<li class="start"> -->
<!-- 							<div class="join_content"> -->
<!-- 								사업자 등록증 사본 <input type="text" name="corporationRegistrationPdf" -->
